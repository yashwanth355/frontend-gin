  ...
  useEffect(() => {
    ...
    // }).then((res) => {
      var res = {
        ...
        shipping_city: props.data.city,
        shipping_country: {label: props.data.country, value: props.data.country},
        shipping_postalcode: props.data.postalcode,
        shipping_state: props.data.state,
        shipping_street: props.data.street,
        shipping_primary: props.data.primary
      };
      setShippingInfo(res);
      let temp = {};
